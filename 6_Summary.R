...
clusters2 <- c(
  ...
  `DFA Î±1 ExpMean` = 6, CD = 6, `DFA Î±1 ExpRange` = 6, KFD = 6, 
  SD1SD2 = 7, HFn = 7, HFD = 7,
  `DFA Î±1 DimMean` = 8, `DFA Î±2 ExpRange` = 8, `DFA Î±2 DimRange` = 8,
  `DFA Î±2` = 8, `DFA Î±2 ExpMean` = 8, `CSI (modified)` = 8,
  CSI = 8, LFn = 8, LFHF = 8, `DFA Î±1` = 8, 
...
dendro <- plot_dendrogram(model, clusters = clusters2, ylim = -0.2, nudge_y = -0.03, angle = 90, points = TRUE, dis = centrality) +
