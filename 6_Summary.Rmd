...
clusters <- cutree(model, h = 0.5)

# identify center of each cluster 
dis <- parameters::cluster_centers(datawizard::data_transpose(z), clusters)


dendro <- plot_dendrogram(model, clusters = clusters, ylim = -0.2, nudge_y = -0.03, angle = 90, points = TRUE, dis = attributes(dis)$distance, h=0.15) +
