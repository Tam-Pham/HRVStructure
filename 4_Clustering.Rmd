...
rez <- cluster_analysis(z, standardize = FALSE, n = 2, method = "hkmeans")
...
rez <- cluster_analysis(z, standardize = FALSE, n = 7, method = "hkmeans")
...
rez <- cluster_analysis(z, n = 10, method = "hkmeans")
...
rez <- cluster_analysis(z, method = "pamk", distance_method = "euclidean")
...
rez <- cluster_analysis(z, n = NULL, standardize = FALSE, method = "hclust", distance_method = "euclidean", hclust_method = "average", ci = 0.95, iterations = 2000)
...
rez <- cluster_analysis(z, n = NULL, standardize = FALSE, method = "hclust", distance_method = "euclidean", hclust_method = "average", ci = 0.90, iterations = 2000)
...
rez <- cluster_analysis(z, n = NULL, standardize = FALSE, method = "dbscan", dbscan_eps = 10, min_size = 2, borderPoints = TRUE)
