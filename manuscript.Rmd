...
Based on the correlation matrix of all HRV indices, identical variables with absolute pairwise correlation of 1 were identified for further examination. As expected, the most prominent group of identical indices included *RMSSD*, *SDSD*, *SD1* and its other derived indices, *SD1a* and *SD1d* [@brennan2001existing; @ciccone2017reminder]. Given the popular usage of *RMSSD* in the literature, it was kept for further analysis while the remaining identical indices were removed. In addition, due to their perfect correlations with other indices, *SDNNa* and *SDNNd* (to *SDNN*), *SD2a* and *SD2d* (to *SD2*), *Cd* (to *Ca*), *C1a* and *C1d* (to *C2a* and *C2d*) were also removed.

Additionally, for each remaining HRV indices, the standard z-scores were calculated for each of their data points and the most extreme values, identified as those that lie beyond the 99.99 percentile, were removed [@iglewicz1993detect].
